...
# --- CLICK HANDLER (Option 1) ---
def handle_click(trace, points, state):
    if points.point_inds:
        idx = points.point_inds[0]
        url = trace.customdata[idx][2]
        display(Markdown(f"**Opened Link:** [{url}]({url})"))
...
fig1.show()
fig1.data[0].on_click(handle_click)   # <<< Option 1 click support
...
fig2.show()
fig2.data[0].on_click(handle_click)


# ============================================================
# ☁️ PLOT 3 — Word Cloud (unchanged)
# ============================================================
...
# ============================================================
# 🥧 PLOT 4 — Author Activity Pie Chart (unchanged)
# ============================================================
...
fig4.show()
# Pie chart does not support click events with customdata → skip


# ============================================================
# 📊 PLOT 5 — Score Ranking (ALL rows)
# ============================================================
...
fig5.show()
fig5.data[0].on_click(handle_click)


# ============================================================
# 📊 PLOT 6 — Sentiment Ranking (ALL rows)
# ============================================================
...
fig6.show()
fig6.data[0].on_click(handle_click)


# ============================================================
# 📊 PLOT 7 — Title Length vs Score Scatter
# ============================================================
...
fig7.show()
fig7.data[0].on_click(handle_click)


# ============================================================
# 📊 PLOT 8 — Sentiment vs Title Length Scatter
# ============================================================
...
fig8.show()
fig8.data[0].on_click(handle_click)
